  ...
  query: new GraphQLObjectType({
    ...
    fields: {
      ...
      clinicalTrials: {
        ...
        resolve: (_, { patientsSortDirection, countriesSortDirection, countryListCollection }) => {
          ...
          if (countriesSortDirection !== null) {
            baseQuery = baseQuery.orderBy("country", countriesSortDirection);
          }
          if (countryListCollection !== null) {
            baseQuery =  baseQuery.where("country", countryListCollection);
          }
